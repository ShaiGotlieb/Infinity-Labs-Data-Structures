...
*
* Returns - a pointer to the Doubly Linked List. if DLLCreate failed, NULL is returned.
*
***********************************************************************/
...
*
***********************************************************************/
/*TEST: try with empty and not empty list*/

boolean_t DLLIsEmpty(const dll_t *list);

/***********************************************************************
* DllIsEmpty - checks if the Doubly Linked List is empty
*
* list - a pointer to the Doubly Linked List not NULL.
*
* Returns - boolean_t TRUE or FALSE.
***********************************************************************/
/*TEST: try with empty and not empty list*/
...
***********************************************************************/
/*TEST: try with empty and not empty list - Test with DLLGetData*/
...
* not found in the list, the function behaviour is undefined. not NULL.
*
* Returns - data in the position specified by iterator.
***********************************************************************/
/*TEST: test for the beginning, middle, end of list*/
...
* iterator - should not be the last member of the list. not NULL.
*
...
* iterator - a position in a Doubly Linked List. If iterator is
* not found in the list, the function behaviour is undefined. 
* iterator - should not be the first member of the list. not NULL.
*
...
* FALSE - if otherwise.
***********************************************************************/
/*TEST: test for the equal, different iterators */
...
***********************************************************************/
/*TEST: insert to an empty list, insert to non-empty list, list with 1 element */
/*insert to beginning, middle, end. Check all elements are in the correct place*/
...
* Returns - iterator - pointing to the position of the new member.
***********************************************************************/
/*TEST: push to an empty list, push to non-empty list, list with 1 element*/
/*check all elements are in the correct place. Check size*/
...
*
* iterator - a position to a member in the list.
*
...
***********************************************************************/
/*TEST: try to erase first, middle, last member.*/
...
*
***********************************************************************/
/*TEST: try to use with list with 1 member, list with */
/*more than 1 member. Try multiple times - pop until empty while checking*/
/* size*/
...
*
***********************************************************************/
/*TEST: when data is not in range, when data is in range*/
/*duplicated data, when data == NULL*/
...
***********************************************************************/
/*TEST: check data after action is performed.*/
...
* beforewhich the range will be inserted.
*
* from - a member location in the first list from which
* the splicing will be started (inclusive).
*
* to - a member location in the first list from which the splicing
* will be ended (exclusive).
*
***********************************************************************/
/*TEST*/
/*range of 1, range of many, where iterator to empty list,*/
/*same list with no overlap*/
/*from is beginning, to is end.*/
/*splice entire list to a new, empty list*/
